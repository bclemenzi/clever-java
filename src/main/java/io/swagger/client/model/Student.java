...
public class Student {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, created, credentials, district, dob, ellStatus, email, enrollments, gender, graduationYear, grade, hispanicEthnicity, homeLanguage, iepStatus, lastModified, location, name, race, school, schools, sisId, stateId, studentNumber, unweightedGpa, weightedGpa, ext);
  }
